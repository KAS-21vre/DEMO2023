...
namespace Ykrasheniya
{
    ...
    public partial class YkrasheniyaEntities : DbContext
    {
        public YkrasheniyaEntities()
            : base("name=YkrasheniyaEntities")
        {
        }
        ...
        public virtual DbSet<ПродукцияВПродажах> ПродукцияВПродажах { get; set; }
